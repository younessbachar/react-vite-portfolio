...
const Skills = () => {
  ...
  return (
    <div className="px-15 md:px-30 pt-20" id="skills">
      <motion.h1
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {myskills.map((skill, index)=>(
          <motion.div
            ...
            className="block p-4  border border-gray-200 rounded-lg shadow shadow-lg bg-gray-800 dark:border-gray-700 dark:hover:bg-teal-300/20"
          >
            ...
            <p className="font-normal text-sm text-center text-gray-700 py-2 dark:text-gray-400">
            {skill.description}
            </p>
            <p className="font-normal text-gray-700 dark:text-gray-400">{skill.subicons}</p>
          </motion.div>
        ))}
      </div>
    </div>
