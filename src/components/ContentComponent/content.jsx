...
const Content = () => {
  return (
    <div className='bg-[#1f1f3f]'>
      ...
      <Skills />
      <ContactMe />
      <a href="https://wa.me/+212691648546"><img src={socialimage} className="fixed bottom-10 right-8 md:right-10 w-12 h-12 hover:animate-bounce hover:cursor-pointer"></img></a>
    </div>
  )
}
